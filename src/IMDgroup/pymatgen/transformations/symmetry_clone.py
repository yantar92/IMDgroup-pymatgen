...
from pymatgen.core import (SymmOp, Structure, Species)
...
class SymmetryCloneTransformation(AbstractTransformation):
    ...
    def __init__(
        ...
        """
        self.species_set = set(map(Species, species_list))
